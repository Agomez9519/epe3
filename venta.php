...
<body>
    ...
    <div class="contenido">
            ...
            <h2 class="display-4" style="text-align: center;">Venta Del Servicio</h2><br>
            ...
            $resulset=mysql_query($sql) or die(mysql_error());;

            $dato=mysql_fetch_array($resulset);

            
            ?>

    <form action="venta2.php" method="post">
       
         <div class="form-group">
        <input type="hidden" id="id" name="id" > 
        <p>ID Del Servicio: <input type="text" class="form-control" id="ids" name="ids" value="<?php echo $dato['0'];?>"> </p>
        <p>Fecha De Inicio:  <input type="text" class="form-control" id="fechai" name="fechai" ><small id="fecha" class="form-text text-muted">Use el formato aaaa-mm-dd-</small> </p>
        <p>Fecha De Termino: <input type="text" class="form-control" id="fechat" name="fechat"><small id="fecha" class="form-text text-muted">Use el formato aaaa-mm-dd</small> </p>
        <p>Hora: <input type="text" class="form-control" id="hora" name="hora" ><small id="hora" class="form-text text-muted">Use el formato 00:00:00</small> </p>
        <p>Tipo De Pago: <input type="text" class="form-control" id="tipop" name="tipop"></p>
        <br>
        </div>  
